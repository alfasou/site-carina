...
!(function () {
      ...
      (da = new b(function (t) {
        ...
        la ||
          ...
          Q(t).forEach(function (t) {
            var a, e, n;
            'childList' === t.type && 0 < t.addedNodes.length && !ia(t.addedNodes[0]) && (X.searchPseudoElements && s(t.target), r(t.target)),
              ...
              'attributes' === t.type &&
                ...
                ((e = t.target), (n = e.getAttribute ? e.getAttribute(C) : null), (e = e.getAttribute ? e.getAttribute(P) : null), n && e)
                  ? ((e = (a = Lt(Z(t.target))).prefix), (a = a.iconName), t.target.setAttribute(C, e || i), a && t.target.setAttribute(P, a))
  ...
  function ja(t) {
    return (
      t.attributes && (t.attributes.fill || !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1]) && (t.attributes.fill = 'black'), t
    );
  }
  var Ma;
